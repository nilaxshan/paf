        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link " href="admin-view-productType.jsp">
                  <i class="material-icons">vertical_split</i>
                  <span>Product Types</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="admin-add-productType.jsp">
                  <i class="material-icons">note_add</i>
          ...
          <div class="main-content-container container-fluid px-4">
		   ...
		   <div class="col-lg-12 col-md-12">
                ...
                <div class="card card-small mb-3">
                  <div class="card-body">
                    <form class="admin-add-new-post">
					<span>Product Type </span>
                      <input class="form-control form-control-lg mb-3" type="text" placeholder="Your product Type">
                     <span>Main Category </span>
                      <input class="form-control form-control-lg mb-3" type="text" placeholder="Category">
                     <span>Sub Category </span>
                      <input class="form-control form-control-lg mb-3" type="text" placeholder="Category">
					<span>Description </span>
                      <textarea class="form-control form-control-lg mb-3"> </textarea>
                    </form>
                  </div>
                </div>
                <!-- / Add New Post Form -->
